...
if (isset($_POST['user']) && isset($_POST['pass'])) {
    ...
    if (empty($user)) {
        ...
        if ($result['code'] == 0) {
            ...
            if ($data['authorize'] == 'admin') {
                header('Location: admin.php');
            } elseif ($data['authorize'] == 'staff') {
...
<head>
    ...
    <style>
        ...
        .gradient-bg {
            background: linear-gradient(to right, rgba(232, 211, 192, 1), rgba(201, 167, 123, 0.7));
            /* Softer gradient */
            display: flex;
        ...
        .login-box h3 {
            font-size: 1.8rem;
            color: #6a1000;
            /* Match the dark red from the theme */
            font-weight: bold;
            text-align: center;
        }
        ...
        .text-primary {
            ...
            /* Light color for links to match the left side theme */
        }
            ...
            <div class="login-box p-4">
                ...
                <form method="post" action="">
                    ...
                    <div class="form-group text-center">
                        <p class="text-dark">Don't have an account? <a href="register.php"
                                class="text-primary">Register</a>.</p>
                        <p class="text-dark">Forgot password? <a href="forgot.php" class="text-primary">Reset it</a>.
                        </p>
                    </div>
                </form>
            </div>
