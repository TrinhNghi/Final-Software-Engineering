...
<body>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-1">
                                    ...
                                    &nbsp;|&nbsp;
                                    <strong>Price:</strong> <?php echo htmlspecialchars($room['price']); ?> VND/night
                                </p>
    ...
    <script>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-1">
                                    ...
                                    <strong>Price:</strong> ${room.price ? parseFloat(room.price) : '0.00'} VND/night
                                </p>
                                <p class="card-text mt-2">
        ...
        $('#bookingModal').on('show.bs.modal', function (event) {
            ...
            modal.find('#roomPrice').val(roomPrice+'VND');
